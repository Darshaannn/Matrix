...
const Navbar: React.FC = () => {
    ...
    return (
        ...
        >
            <div className="bg-slate-900/40 backdrop-blur-2xl border border-white/10 text-white px-8 py-2 rounded-full flex items-center shadow-[0_20px_50px_rgba(0,0,0,0.3)] h-16 pointer-events-auto transition-all hover:border-amber-500/30 group/nav">
                {/* Logo Section */}
