...
const Footer: React.FC = () => {
    return (
        <footer id="contact" className="bg-[#0F172A] text-slate-400 py-20 px-4 md:px-12 border-t border-white/5 relative z-10">
            ...
            {/* Copyright & Social */}
            <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 text-xs font-mono tracking-wider">
                <p>&copy; {new Date().getFullYear()} Matrix Media Consortium. All rights reserved.</p>
                <div className="flex items-center gap-8">
                    <div className="flex gap-4">
                        <a href="#" className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center border border-white/10 hover:bg-blue-500/20 hover:border-blue-500/40 transition-all">
