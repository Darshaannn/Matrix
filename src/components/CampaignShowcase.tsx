...
const campaigns = [
    {
        brand: 'ITC – Sunfeast & Bingo',
        dealValue: '₹45 Cr',
        channels: ['Print', 'OTT', 'Cinema', 'Radio'],
        objective: 'Pan-India brand amplification across regional markets.',
        impact: 'Sunfeast achieved double-digit recall lift in Tier 2 cities without cash outflow, proving structured barter delivers measurable brand equity.',
        accentColor: '#3B82F6',
    ...
    },
    {
        ...
        objective: 'National prestige campaign for Titan Watches & Tanishq.',
        ...
        accentColor: '#00C2FF',
        stats: [{ label: 'Media Channels', value: '4 Platforms' }, { label: 'Reach', value: '600M+' }, { label: 'Deal Value', value: '₹350 Cr' }],
    },
    {
        brand: 'Bajaj Auto',
        dealValue: '₹75 Cr',
        channels: ['TV', 'Radio', 'Cinema', 'Outdoor'],
        objective: 'Launch campaign for Pulsar NS series across South & West India.',
    ...
    },
    {
        brand: 'Havells India',
        dealValue: '₹52 Cr',
        channels: ['OTT', 'Digital', 'Print', 'Radio'],
        objective: 'Festive season push for appliance category across pan-India.',
        impact: 'Category market share expanded from 18% to 24% in key geographies through coordinated cross-platform storytelling during the festive window.',
        accentColor: '#10B981',
        stats: [{ label: 'Category Share', value: '+6 pts' }, { label: 'Platforms', value: 'OTT + Radio' }, { label: 'Structured', value: '₹52 Cr' }],
    },
];
